                    ...
                    <!----------
                        <div class="row">
                            <div class="col-sm-4 sec-content">
                                <a href="myItem.php?sid=4">
                                <h4>نام محصول</h4>
                                    <img src="../imgs/w1.jpg">
                                <h5>فروشنده : نام فروشنده</h5>
                                </a>
                            </div>
                            <div class="col-sm-4 sec-content">
                                <a href="myItem.php?sid=4">
            ...
            <div class="col-sm-2 text-center " id="ver-nav">
                    <div id="slider_rapper">
                        <ul class="nav nav-pills nav-stacked">
                            <li ><a id="i_1" href="#" >لبتاب</a></li>
                            <li><a id="i_3" href="#">موس</a></li>
                            <li><a id="i_4" href="#">کیبورد</a></li>
                            <li><a id="i_5" href="#">هدفون</a></li>
                            <li><a id="i_6" href="#">اسپیکر</a></li>
                            <li><a id="i_7" href="#">وبکم</a></li>
                            <li><a id="i_8" href="#">میکروفن</a></li>
                            <li><a id="i_9" href="#">مانیتور</a></li>
                        </ul>
                    </div>
            </div>
        </div>
<!---------------------------------------------------- footer ----------------------------------------------------------------------->
    ...
    <script src="../js/jquery/sectionContentAjax.js"></script>
    <script src="../js/jquery/categoriesAjax.js"></script>
</body>
</html>